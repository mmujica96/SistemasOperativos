 ...
 * BMP header (54 bytes).
 */
//define el encabezado del archivo BMP, para describir la imagen y sus propiedades
...
//estructura de la imagenBMP, con su encabezado, altura normalizada, cantidad de bytes por pixel y un puntero a una matriz de pixeles
